...
public class UpcomingMoviesPresenter implements UpcomingMoviesContract.Presenter {
    ...
    @Inject
    public UpcomingMoviesPresenter(final DatabaseInterface databaseInterface, final MovieInteractor movieInteractor) {
        this.databaseInterface = databaseInterface;
        this.movieInteractor = movieInteractor;
    }

    @Override
    public void setView(final UpcomingMoviesContract.View view) {
        this.view = view;
    }
